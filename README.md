...
- Total traffic since tracking began
- Daily traffic charts with a seven-day average
- Repository rankings
- Combined referring-site statistics
- The most-viewed paths across your repositories

Each repository also receives its own dashboard:

```text
data/repos/repository-name/README.md
```
